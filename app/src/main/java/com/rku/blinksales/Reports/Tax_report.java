...
public class Tax_report extends AppCompatActivity {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!id_from_date.getText().toString().trim().equals("dd-MMM-yyyy") && !id_to_date.getText().toString().trim().equals("dd-MMM-yyyy")) {
                    Toast.makeText(Tax_report.this, "From : " + id_from_date.getText().toString() + " To : " + id_to_date.getText().toString(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Tax_report.this, "Please select date", Toast.LENGTH_SHORT).show();
                }
            }
        });
