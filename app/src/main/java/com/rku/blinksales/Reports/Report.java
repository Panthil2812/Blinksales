        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!id_from_date.getText().toString().trim().equals("dd-MMM-yyyy") && !id_to_date.getText().toString().trim().equals("dd-MMM-yyyy")) {
                    Toast.makeText(Report.this, "From : " + id_from_date.getText().toString() + " To : " + id_to_date.getText().toString(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Report.this, "Please select date", Toast.LENGTH_SHORT).show();
                }
            }
        });
