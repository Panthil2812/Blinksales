...
public class Remain_payment_list  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_remain_payment_list, container, false);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.nav_remain_payment_list);
        ...
        //view main code
        filter_Calendar = view.findViewById(R.id.remain_filter_Calendar);
